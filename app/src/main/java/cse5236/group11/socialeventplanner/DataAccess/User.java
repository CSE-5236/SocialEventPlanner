package cse5236.group11.socialeventplanner.DataAccess;
...
public class User {
    ...
    public List<String> selectAll(String username, String password) {
        ...
        Cursor cursor = this.db.query(TABLE_NAME, new String[] { "User_Name", "Password" }, "User_Name = '"+ username +"' AND Password= '"+ password+"'", null, null, null, "name desc");
