...
public class Robotium extends ActivityInstrumentationTestCase2<SplashScreen> {
	...
	public void testRun() {
		...
		solo.enterText((android.widget.EditText) solo.getView(cse5236.group11.socialeventplanner.R.id.username_text), "nandu");
		...
		solo.enterText((android.widget.EditText) solo.getView(cse5236.group11.socialeventplanner.R.id.password_text), "nandu");
        //Click on Login
		...
		solo.enterText((android.widget.EditText) solo.getView(cse5236.group11.socialeventplanner.R.id.username), "nandu");
        //Click on Empty Text View
		...
		solo.enterText((android.widget.EditText) solo.getView(cse5236.group11.socialeventplanner.R.id.password), "nandu");
        //Click on Empty Text View
		...
		solo.enterText((android.widget.EditText) solo.getView(cse5236.group11.socialeventplanner.R.id.password_confirm), "nandu");
        //Click on Done
        ...
        //Click on ImageView
		solo.clickOnView(solo.getView(android.widget.ActionMenuView.class, 0));
		...
		solo.enterText((android.widget.EditText) solo.getView(cse5236.group11.socialeventplanner.R.id.event_name), "buckeye 4 lyfe");
        //Click on Empty Text View
		...
		solo.enterText((android.widget.EditText) solo.getView(cse5236.group11.socialeventplanner.R.id.event_location), "Oval");
        //Click on Empty Text View
